...
permalink: /
subtitle:
  CTO & Co-founder of <a href='https://www.radixark.ai/'>RadixArk</a>.
...
I'm the CTO & co-founder of [RadixArk](https://www.radixark.ai/), where we're bringing frontier-level AI infrastructure to everyone. We believe deeply in building in the open.
...
Previously, I co-founded [Nexusflow AI](https://nexusflow.ai/) in 2023, providing reliable AI agent solutions for enterprise use-cases.
...
- **[Starling-7B](https://starling.cs.berkeley.edu)** --- Open 7B model, ranked #1 among Mistral-based 7B models on Chatbot Arena.
- **[Athene-V2-72B](https://huggingface.co/Nexusflow/Athene-V2-72B-Chat)** --- Open model competitive with GPT-4o, ranked only behind Deepseek V3/R1 (671B) among non-reasoning open models on Chatbot Arena.
- **[Chatbot Arena](https://chat.lmsys.org/)** & **[Arena-Hard-Auto](https://github.com/lm-sys/arena-hard-auto)** --- Core contributor to the most widely-used LLM evaluation platforms.
